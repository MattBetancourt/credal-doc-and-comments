...
export const googleOauthReadCommentsOnDocDefinition: ActionTemplate = {
  ...
  description:
    "Read Google Doc comments with Drive metadata and exact anchor mapping from DOCX export or raw uploaded DOCX files",
  ...
  parameters: {
    ...
    properties: {
      documentId: {
        type: "string",
        description: "The ID of the Google Doc or DOCX file to read comments from",
        tags: ["recommend-predefined"],
      },
      includeDeleted: {
        type: "boolean",
  ...
  output: {
    ...
    properties: {
      ...
      comments: {
        type: "array",
        description: "Array of comment threads",
        items: {
          type: "object",
          required: ["commentId"],
          properties: {
            commentId: {
              type: "string",
              description: "Stable Google Drive comment ID or DOCX-local ID",
            },
            docxCommentId: {
              type: "string",
              description: "DOCX-local comment ID if an exported comment was matched",
            },
            content: {
              type: "string",
      ...
      warnings: {
        type: "array",
        description: "Non-fatal limitations",
        items: {
          type: "string",
        },
      },
